...
try:
    ...
    print("Verifica que el archivo Excel esté en la misma carpeta que este script.")
    exit()
...
with open('resultados_analisis_sismos.txt', 'w', encoding='utf-8') as f:
...
print("✅ Resultados guardados en 'resultados_analisis_sismos.txt'")
